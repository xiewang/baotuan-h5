...
const weChatLogin = (params) => {
    window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1425c0f4c2e6e3cd&redirect_uri=&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'
}
